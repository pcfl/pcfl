# Reference to https://github.com/cuis15/FCFL/blob/main/FUEL/dataset_generate.py
...
training_dir = "data/adult.train"
testing_dir = "data/adult.test"
            ...
            if is_feature_continuous:
                ...
                for j in range(features_of_this_type):
                    ...
                    if feature_name == person_inputs[i]:
                        ...
                        # if inputs[i][0] == "race":
                        # print("race:", len(float_inputs))
                        # if inputs[i][0] == "sex":
                        #     print("sex:", len(float_inputs))
